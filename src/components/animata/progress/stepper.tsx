import React, {
  ...
  export default function Stepper({
    ...
    const handleStepClick = (clickedStep: number) => {
      ...
      if (canNavigateToStep && !canNavigateToStep(clickedStep, currentStep)) {
  ...
  function StepIndicator({
    ...
    const isClickable = step !== currentStep && 
      ...
      (!canNavigateToStep || canNavigateToStep(step, currentStep));
      ...
      >
        <motion.div
          variants={{
            inactive: { 
              scale: 1, 
              backgroundColor: isClickable ? "#222" : "#666", 
              color: isClickable ? "#a3a3a3" : "#888" 
            },
